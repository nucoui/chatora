  ...
  return (
    <main className={styles["main-content"]}>
      ...
      <div className={styles.links}>
        <Button type="anchor" href="/get-started">
          <span>
            Get Started
          </span>
        </Button>
        <Button type="anchor" variant="secondary" href="https://github.com/nucoui/chatora" target="_blank">
          <span>
        ...
        <Button type="anchor" variant="secondary" href="https://www.npmjs.com/package/chatora" target="_blank">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32"><path fill="currentColor" d="M4 28V4h24v24zM8.5 8.5v15H16v-12h4.5v12h3v-15z" /></svg>
            npm
          </span>
        </Button>
      </div>
